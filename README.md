...
🏙️ "Market Cap": Kapitalisasi pasar Bitcoin, yang merupakan total nilai pasar dari semua Bitcoin yang beredar. Ini dihitung dengan mengalikan jumlah total Bitcoin yang beredar dengan harga per unitnya.
...
⚖️ **circulating_supply**: Jumlah total Bitcoin yang saat ini beredar di pasar. Ini adalah jumlah koin yang tersedia untuk diperdagangkan dan dipegang oleh pengguna.
 </p> 
